    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-12">
                ...
                <div class="col-sm-6">
                    <a href="{{url('/api/map')}}" target="_blank"><button class="btn btn-danger">Access Json</button></a>
                </div>
                <div class="col-sm-6"></div>
                <hr>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            @foreach($parser as $key => $value)
                                ...
                                @endphp
                                <tr>
                                    <th scope="row">{{ stristr($value['content']['$t'],', message:',", ")}}</th>
                                    <th scope="row">{{$step_2}}</th>
                                    <th scope="row">{{ stristr($value['content']['$t'],'sentiment')}}</th>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
